...
ROOT_URLCONF = "sideshow.settings.urls"

DATABASE_HOST = os.environ.get("DATABASE_HOST", "psql")
DATABASE_NAME = os.environ.get("DATABASE_NAME", "sideshow")
DATABASE_USER = os.environ.get("DATABASE_USER", "sideshow")
DATABASE_PORT = os.environ.get("DATABASE_PORT", "5432")
DATABASE_PASSWORD = os.environ.get("DATABASE_PASSWORD", "sideshow")
DATABASES = {
...
APP_HOSTNAME = os.environ.get("APP_HOSTNAME", "sideshow.boundcorp.net")
...
BACKEND_FOLDER = SITE_ROOT + "/sideshow"
