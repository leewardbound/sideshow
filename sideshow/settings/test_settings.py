...
if "TEST_USE_ENV" not in os.environ:
    ...
    del sys.modules["sideshow.settings"]
    del sys.modules["sideshow.settings.project"]

from sideshow.settings import *
...
EMAIL_BACKEND = "sideshow.conf.test_settings.MockEmailBackend"
